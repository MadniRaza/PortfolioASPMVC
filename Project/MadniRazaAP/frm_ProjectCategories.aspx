<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="frm_ProjectCategories.aspx.cs" Inherits="frm_ProjectCategories" %>
        ...
        <div class="module-body">
            ...
            <asp:UpdatePanel ID="up" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="gv_PC" runat="server" CssClass="table table-striped table-bordered table-condensed"
                        AutoGenerateColumns="False" ShowFooter="True" EmptyDataText="No record(s) found."
                        DataKeyNames="project_category_id" AllowPaging="True" OnPageIndexChanging="gv_Users_PageIndexChanging">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <center>
                            ...
                            <asp:BoundField DataField="project_category_id" HeaderText="ID" />
                            <asp:BoundField DataField="project_category_name" HeaderText="NAME" />
                            <asp:BoundField DataField="project_category_status" HeaderText="USER TYPE" />
